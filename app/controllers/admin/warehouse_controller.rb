class Admin::WarehouseController < ApplicationController
  ...
  def data
    ...
    warehouses.each do |warehouse|
      action = ''
      action += "<a class='dropdown-item' href='#{admin_warehouse_show_path(id: warehouse.id)}' data-controller='turbo'><span class='bi bi-eye text-info'></span> Mostrar</a>" if show_html('show')
      action += "<a class='dropdown-item' href='#{admin_warehouse_edit_path(id: warehouse.id)}' data-controller='turbo'><span class='bi bi-pencil text-warning'></span> Editar</a>" if show_html('edit')
      action += "<a class='dropdown-item' href='javascript:;' data-action='admin#delete' data-target='#{admin_warehouse_delete_path(id: warehouse.id)}'><span class='bi bi-trash text-danger' data-action='admin#delete' data-target='#{admin_warehouse_delete_path(id: warehouse.id)}'></span> Eliminar</a>" if show_html('delete')
